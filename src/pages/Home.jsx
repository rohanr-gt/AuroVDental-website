      ...
      <section id="our-work" className="py-32 px-6 bg-[color:var(--soft)] overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-white border border-[color:var(--teal)]/10 text-[color:var(--teal)] text-xs font-bold uppercase tracking-[0.2em] mb-6">
            ...
            <h2 className="text-5xl md:text-6xl font-serif font-bold text-[color:var(--dk)] mb-6">
              Witness the <span className="italic text-[color:var(--teal)]">Magic</span> of Our Work
            </h2>
